...
# def download_data_crypto(par):
#     crypto = None
#     date_init = '2014-01-01'
#     date_now = datetime.strftime(datetime.today(), "%Y-%m-%d")
#     if par and isinstance(par, str) and par.upper() in PAIRS:
#         crypto = yf.download(f"{par.upper()}-USD", date_init, date_now)
#     return crypto
